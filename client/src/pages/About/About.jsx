  ...
  return (
    <div className="about-page">
      ...
      <div className="about-banner">
        {/* Arka Plan Resmi */}
        <img
          src="https://images.unsplash.com/photo-1700665537650-1bf37979aae0?q=80&w=2072&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="VetCare Ekibi"
      ...
      <div className="container">
        {/* --- 2. VİZYON & MİSYON (Banner'ın hafif üzerine biner) --- */}
        ...
        <section className="team-section">
          <div className="team-header">
            ...
            <p className="team-subtitle">
              Sizlere en iyi hizmeti sunmak için çalışan 20 kişilik dev
              kadromuz.
            </p>
          </div>
